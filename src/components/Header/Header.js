  ...
  return (
    <HeaderStyles>
      <header className="header flex items-center justify-between fixed w-full top-0 h-[60px] lg:h-[80px] px-[16px] lg:px-[20px]">
        ...
        <div
          className={`nav-items absolute lg:static top-full left-0 w-full bg-white lg:flex lg:transition-all lg:duration-300 lg:ease-in-out ${isMenuOpen ? "flex" : "hidden"
            }`}
        >
          <ul className="flex flex-col lg:flex-row lg:h-full w-full">
            <li className="flex items-center">
              <Link className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" to="#!">
            ...
            <li className="flex items-center md:ml-[60px]">
              <Link className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" to="/offers">
                ...
                <span>
                  Offers<sup className="text-[#fc8019] text-[10px]">NEW</sup>
                </span>
              </Link>
            </li>
            <li className="flex items-center md:ml-[60px]">
              <Link className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" to="/help">
            ...
            <li className="flex items-center md:ml-[60px]">
              <Link className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" to="#!" onClick={isLoggedIn ? handleLogout : toggleLoginPopup}>
                ...
                <span className="truncate capitalize">{isLoggedIn ? username : "Login"}</span>
              </Link>
            </li>
            <li className="flex items-center md:ml-[60px]">
              <Link className="flex items-center h-full relative px-[25px] py-[10px] md:px-0 md:py-0" to="#!">
                <svg
                  className="cart-svg"
                  viewBox="-1 0 37 32"
                  height="20"
        ...
        <div className="hamburger-btn lg:hidden">
        ...
        <div className="login-popup fixed h-full w-full bg-[rgba(0,0,0,0.6)] top-0 left-0 z-[999]">
          <div className="login-form mx-auto bg-white w-[50%] relative rounded-[10px] mt-[150px]">
            <form onSubmit={handleLogin} className="flex flex-col justify-center items-center p-[30px]">
              ...
              <label className="flex justify-center items-center w-[70%] mb-[20px]">
                <strong className="font-semibold text-[20px] mr-[20px]">Password:</strong>
                <input type="password" name="password" required className="search-input border-[rgba(40,44,63,.2)] border-[1px] rounded-[4px] h-[48] w-full px-[16px]" />
              </label>
