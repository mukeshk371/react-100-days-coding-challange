        ...
        >
          <ul className="flex flex-col lg:flex-row lg:h-full w-full">
            <li className="flex items-center">
              <a className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" href="#!">
            ...
            <li className="flex items-center md:ml-[60px]">
              <a className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" href="/offers">
            ...
            <li className="flex items-center md:ml-[60px]">
              <a className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" href="/help">
            ...
            <li className="flex items-center md:ml-[60px]">
              <a className="flex items-center h-full px-[25px] py-[10px] md:px-0 md:py-0" href="#!" onClick={isLoggedIn ? handleLogout : toggleLoginPopup}>
            ...
            <li className="flex items-center md:ml-[60px]">
              <a className="flex items-center h-full relative px-[25px] py-[10px] md:px-0 md:py-0" href="#!">
                <svg
                  className="cart-svg"
                  viewBox="-1 0 37 32"
                  height="20"
